...
int main()
{
  ...
  cout << "Objective: This program will generate a random number between 1 and 10 that needs to be guessed by the user\n"; 
  ...
  while (true){
    cout << "Please enter your guess between 1 and 10" << endl;
    cin >> guess;
    cin.ignore (1000,10);
    if (guess==number)
      break;
